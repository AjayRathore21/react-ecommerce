  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        <div className="lg:col-span-3 mt-8 mb-8">
          <form>
        ...
        <div className="lg:col-span-2 ">
          <div className="mx-auto bg-white pb-6  max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mt-8 pt-0.5 mx-auto max-w-7xl px-4  sm:px-6 lg:px-8">
              <h2 className="text-4xl my-8  text-center font-bold tracking-tight text-gray-900">
                Cart
              </h2>
